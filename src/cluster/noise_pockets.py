...
class ClusterReport:
    ...
    def to_json_dict(self, *, profile: str, collection: str, vector_source: str) -> dict:
...
def cluster_threads(
    vectors: np.ndarray, metas: List[ThreadMeta], *, k: int | None = None, seed: int = 11
) -> ClusterReport:
    ...
    return ClusterReport(
        ...
        corpus_baseline_tag_rate=round(baseline, 6),
        clusters=clusters,
    )
