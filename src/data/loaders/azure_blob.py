...
class AzureBlobEmailLoader(EmailLoader):
    ...
    def __init__(
        ...
        self.blob_prefix = blob_prefix or os.environ.get("AZURE_BLOB_PREFIX", "")
    ...
    def load(self, num_samples: Optional[int] = None) -> List[NormalizedEmail]:
        ...
        blobs = [
            b
            for b in container_client.list_blobs(name_starts_with=self.blob_prefix or None)
        ...
        print(f"Downloading {len(blobs)} .eml files from Azure Blob '{self.container_name}'...")
