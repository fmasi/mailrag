...
class TestContentSha256(unittest.TestCase):
    def test_stable_across_line_endings_and_trailing_whitespace(self):
        a = content_sha256(
            sender="a@x.com", subject="Hi", date=None, body="line one\r\nline two   \r\n"
        )
        b = content_sha256(sender="a@x.com", subject="Hi", date=None, body="line one\nline two\n")
...
class TestEmailIdentity(unittest.TestCase):
    def test_normalizes_message_id_and_hashes_content(self):
        ...
        mid, ch = email_identity(sender="a", subject="s", date=None, body="b", message_id="<M@x>")
    ...
    def test_empty_message_id_becomes_none(self):
        ...
        mid, _ = email_identity(sender="a", subject="s", date=None, body="b", message_id="")
