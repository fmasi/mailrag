...
class TestCliDispatch(unittest.TestCase):
    ...
    def test_pass1_verb_previews_partition(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            with (
                mock.patch("src.cli.resolve_index_files", return_value=(["/r/a/x.eml"], [])),
    ...
    def test_build_embed_summary_flows_flag_and_threshold(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            with mock.patch("src.cli.build_stage") as bs, mock.patch("src.cli.BgeM3Embedder"):
                ...
                rc = cli.main(
                    ["build", "--profile", fp, "--embed-summary", "--noise-confidence", "0.8"]
                )
        self.assertEqual(rc, 0)
    ...
    def test_calibrate_verb_records_calibration(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            report = CalibrationReport(
                rubric="personal", sample=5, noise_rate=0.6, false_noise=[], false_keep=[]
            )
            with (
                mock.patch("src.cli.calibrate_stage") as cs,
